...
<script type="text/javascript"> 
	...
	var menuTreeselectNodes=[
			...
			</c:if></c:forEach>{id:new Date().getTime(), pId:"0", name:"<i class=\"icon-home\"></i>&nbsp;进入主页", url:"${ctxAdmin}", target:"_self"},
			{id:new Date().getTime(), pId:"0", name:"<i class=\"icon-share\"></i>&nbsp;退出登录", url:"${ctxAdmin}/logout", target:"_self"}];
