...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxAdmin}/sys/role/">角色列表</a></li>
		<li class="active"><a href="${ctxAdmin}/sys/role/assign?id=${role.id}"><shiro:hasPermission name="sys:role:edit">角色分配</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit">人员列表</shiro:lacksPermission></a></li>
	</ul>
	...
	<div class="breadcrumb">
		...
		<script type="text/javascript">
			$("#assignButton").click(function(){
				top.$.jBox.open("iframe:${ctxAdmin}/sys/role/usertorole?id=${role.id}", "分配角色",810,$(top.document).height()-240,{
