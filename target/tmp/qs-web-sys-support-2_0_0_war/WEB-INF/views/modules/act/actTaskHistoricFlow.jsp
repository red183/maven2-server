...
<table class="table table-striped table-bordered table-condensed">
	<tr><th>执行环节</th><th>执行人</th><th>开始时间</th><th>结束时间</th><th>处理结果</th><th>任务历时</th></tr>
...
<div>
	<img src="${ctxAdmin}/act/process/resource/read?procDefId=${histoicFlowList[0].histIns.processDefinitionId}&resType=image"/>
</div>