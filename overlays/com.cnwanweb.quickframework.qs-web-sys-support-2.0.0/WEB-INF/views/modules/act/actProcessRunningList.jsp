...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctxAdmin}/act/process/running/?pageNo='+n+'&pageSize='+s;
        }
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxAdmin}/act/process/">流程管理</a></li>
		<li><a href="${ctxAdmin}/act/process/deploy/">部署流程</a></li>
		<li class="active"><a href="${ctxAdmin}/act/process/running/">运行中的流程</a></li>
	</ul>
	<form id="searchForm" action="${ctxAdmin}/act/process/running/" method="post" class="breadcrumb form-search">
				...
				<tr>
					...
					<td>
						<shiro:hasPermission name="act:process:edit">
							<a href="${ctxAdmin}/act/process/deleteProcIns?procInsId=${procIns.processInstanceId}&reason=" onclick="return promptx('删除流程','删除原因',this.href);">删除流程</a>
						</shiro:hasPermission>&nbsp;
					</td>
				</tr>
			</c:forEach>
